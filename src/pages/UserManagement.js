...
//   }, [data]);
  ...
  const handleRowClick = async (employee) => {
    try {
      const response1 = await axios.get(`http://172.235.21.99:9591/user/team-member/remarks/${originalempId}`);
...
return (
      ...
      >
        ...
        <div>
          <div style={{marginLeft:"3vw", marginTop:"2vh",display:"flex",width:"100%"}}>
            <Avatar color="brand"  name={selectedEmployee.name} size={96}/>
            ...
            >
                <Tab value="tab1" className={themestate ? "tab dark drawer" : "tab"} style= {{border:'1px solid transparent'}}>Pending Blogs</Tab>
                <Tab value="tab2" className={themestate ? "tab dark drawer" : "tab"} style= {{border:'1px solid transparent'}}>Approved Blogs</Tab>
                <Tab value="tab3" className={themestate ? "tab dark drawer" : "tab"} style= {{border:'1px solid transparent'}}>Published Blogs</Tab>
                <Tab value="tab4" className={themestate ? "tab dark drawer" : "tab"} style= {{border:'1px solid transparent'}}>Pending Mails</Tab>
                <Tab value="tab5" className={themestate ? "tab dark drawer" : "tab"} style= {{border:'1px solid transparent'}}>Approved Mails</Tab>
                <Tab value="tab6" className={themestate ? "tab dark drawer" : "tab"} style= {{border:'1px solid transparent'}}>Published Mails</Tab>
            </TabList>
            {selectedTab1 === 'tab1' && (
                <div style={{marginTop:"30px"}}>
                <PendingBlogsInsideDrawer empId={selectedEmployee.empId}/>
                </div>
            )}

            {selectedTab1 === 'tab2' && (
                <div style={{marginTop:"30px"}}>
                <ApprovedBlogsInsideDrawer empId={selectedEmployee.empId}/>
                </div>
            )}

            {selectedTab1 === 'tab3' && (
                <div style={{marginTop:"30px"}}>
                <PublishedBlogsInsideDrawer empId={selectedEmployee.empId}/>
                </div>
            )}

            {selectedTab1 === 'tab4' && (
                <div style={{marginTop:"30px"}}>
                <PendingMailsInsideDrawer empId={selectedEmployee.empId}/>
                </div>
            )}

            {selectedTab1 === 'tab5' && (
                <div style={{marginTop:"30px"}}>
                <ApprovedMailsInsideDrawer empId={selectedEmployee.empId}/>
                </div>
            )}

            {selectedTab1 === 'tab6' && (
                <div style={{marginTop:"30px"}}>
                <PublishedMailsInsideDrawer empId={selectedEmployee.empId}/>
                </div>
            )}
        </div>
    ...
    <BreadcrumbItem>
      <Link href="/hremployee" className="custom-link">Employee</Link>
        ...
        <h2 style={themestate?{color:'white'}:{}}>User Management</h2>
      {/* <TabList
        defaultSelectedValue='tab1'
        appearance="subtle"
